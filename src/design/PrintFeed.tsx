...
export function PrintFeed({
  ...
  const measure = useCallback(() => {
    ...
    return {
      ...
      topOf: (k: number) => at(k)?.offsetTop ?? 0,
      heightOf: (k: number) => at(k)?.offsetHeight ?? 0,
    };
  }, [items.length]);
  ...
  return (
    <div className="stage feed-stage" ref={stageRef}>
      <PrinterHousing label={label} />
